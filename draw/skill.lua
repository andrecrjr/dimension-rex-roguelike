function _skill_draw()
    -- Limpa a tela (opcional, dependendo do contexto)
    -- cls()

    -- Fundo do menu (retângulo preenchido) - Ajustado para ser maior e centralizado
    ...
    -- Desenha o título principal dentro do retângulo
    print("Level UP!", 46, 20, 6)  -- Centralizado horizontalmente e posicionado no topo do retângulo

    -- Desenha o texto "Choose your next Skill" abaixo do título
